(function () {
    ...
    .controller("employeeCntrl", function ($scope, employeeService, $filter, $state, $stateParams, employeeSettingsService, appSettings) {
        //urlPath
        $scope.serverPath = "http://localhost:51995";
