(function () {
    ...
    angular
        .module("myApp")
        .controller("financeCntrl", function ($scope, financeService, $filter, $state, $stateParams, employeeSettingsService) {
...
.controller("singleFinanceCntrl", function ($scope, financeService, $filter, $state, $stateParams, employeeSettingsService) {
