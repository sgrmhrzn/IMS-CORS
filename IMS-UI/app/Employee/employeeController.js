(function () {
    ...
    .controller("employeeCntrl", function ($scope, employeeService, $filter, $state, $stateParams, employeeSettingsService, appSettings, currentUser) {
        ...
        function getAll() {
            ...
            var getData = employeeService.getAllRecords();

            getData.then(function (prs) {
                $scope.EMPLOYEE = prs.data;
    ...
    .controller("singleEmployeeCntrl", function ($scope, employeeService, $filter, $state, $stateParams, employeeSettingsService) {
        //urlPath
        $scope.serverPath = employeeService.apiPath();
        ...
        function getRecordById() {
            ...
            var getData = employeeService.getRecordById($stateParams.id);
            ...
            getData.then(function (prs) {
                ...
                $scope.DEPTID = $scope.profile.DEPTID;
        ...
        $scope.AddUpdate = function () {
            ...
            if (getAction == "Update") {
                ...
                var getData = employeeService.AddRecord(EMPLOYEE);
                getData.then(function (msg) {
        ...
        $scope.delete = function (emp) {
            ...
            if (result) {
                var getData = employeeService.deleteRecord(emp);
                getData.then(function (msg) {
                    //alert(msg.data);
                }, function () {
