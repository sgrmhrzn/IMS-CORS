app.controller("employeeCntrl", function ($scope, employeeService, $filter, $state, $stateParams, employeeSettingsService) {
    getAll();
    $scope.Action = "Add";
    $scope.EMPLOYEE = [];
    //To Get All Records  
...
app.controller("singleEmployeeCntrl", function ($scope, employeeService, $filter, $state, $stateParams, employeeSettingsService) {
    getRecordById();
    getAllDepartment();
    var EMPLOYEE = [];
